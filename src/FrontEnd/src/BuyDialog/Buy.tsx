...
const BuyDialog: React.FC<BuyDialogProps> = ({ open, handleClose }) => {
  ...
  async function airdropSolana(amount: number) {
    ...
    const secretKeyString =
      "3,15,81,223,228,22,249,246,245,45,154,52,24,231,114,240,131,11,230,24,147,57,57,202,120,210,177,127,122,65,209,127,231,170,97,215,16,114,205,153,189,173,5,87,215,85,95,168,117,207,95,17,160,166,153,184,239,205,51,172,178,137,163,7";
    if (!secretKeyString) {
